...
class FMEFileLister(QWidget):
    ...
    def build_fme_command(self):
        ...
        command_parts = [fme_exe_path, fmw_file_path]
...
class QGISFMEFormConnectorDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        # self.setWindowModality(Qt.WindowModality.WindowModal)  # Removed: handled with NonModal and parent above
        self.setAttribute(Qt.WidgetAttribute.WA_DeleteOnClose, True)
        # self.setWindowFlags(Qt.WindowType.Window | Qt.WindowType.WindowSystemMenuHint | Qt.WindowType.WindowMinMaxButtonsHint | Qt.WindowType.WindowCloseButtonHint)  # Now set above with WindowStaysOnTopHint
