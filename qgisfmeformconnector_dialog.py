# -------------------------------------------------------------------------------
# QGIS-FME Form Connector - Version 0.9.0
# -------------------------------------------------------------------------------
#
...
class FMEFileLister(QWidget):
    ...
    def build_ui(self):
        ...
        about_content = f"""
            <div style='text-align: center; margin-bottom: 20px;'>
                ...
                <p style='color: #7f8c8d; margin-top: 0;'>Version 0.9.0</p>
            </div>
            ...
            for index, line in enumerate(lines):
                ...
                if header_started:
                    ...
                    if "Command line to run this workspace:" in line:
                        ...
                        # Extract paths using simple string splitting
                        parts = command_line.split('"')
                        if len(parts) >= 3:
                            # Get FME path (second part between quotes)
                            fme_path = parts[1]
                            # Get workspace path (first item after quotes)
                            workspace_path = parts[2].split()[0]  # Split by spaces and take first item
                            ...
                            # Set the values
                            self.paths_table.item(0, 0).setText(f'"{fme_path}"')  # Add back the quotes for FME path
    ...
    def build_fme_command(self):
        ...
        command_parts = [f'"{fme_exe_path}" "{self.current_file}"']
